...
| 3 |
| 3 | [stage-3-services-stacks.md](stage-3-services-stacks.md) | Сервисы + стеки + registry auth (FR-04, FR-08, FR-13) | 🔄 в работе |
| 4 | [stage-4-logs-events-audit.md](stage-4-logs-events-audit.md) | Логи, события, audit (FR-05, FR-06) | ⬜ |
| 5 | [stage-5-resources.md](stage-5-resources.md) | Secrets/Configs/Networks/Volumes + prune (FR-09, FR-10, FR-11) | ⬜ |
